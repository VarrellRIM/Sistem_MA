...
<div class="card shadow-sm" style="max-width:580px">
    <div class="card-header" style="background:#f0fdf4; border-color:#bbf7d0">
        ...
        <strong class="text-success">Stock In — Sparepart Restock</strong>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('transactions.storeIn') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <label class="form-label">Supplier / Sender</label>
                    <input type="text" name="requester" class="form-control" value="{{ old('requester') }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Received By (Technician)</label>
                ...
                <div class="col-12 d-flex gap-2">
                    <button type="submit" class="btn btn-success"><i class="bi bi-arrow-down-circle me-1"></i>Confirm Stock In</button>
