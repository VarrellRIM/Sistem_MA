...
<div class="card shadow-sm" style="max-width:720px">
    <div class="card-header"><i class="bi bi-plus-circle me-2"></i>Add New Device</div>
    <div class="card-body">
        <form method="POST" action="{{ route('devices.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="ram_size" class="form-control" value="{{ old('ram_size') }}" min="1">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Storage (GB)</label>
                    <input type="number" name="storage_size" class="form-control" value="{{ old('storage_size') }}" min="1">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="location" class="form-control" value="{{ old('location') }}" placeholder="IT Office, Room 2...">
                </div>
                <div class="col-md-6">
