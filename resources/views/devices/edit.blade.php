...
<div class="card shadow-sm" style="max-width:780px">
    <div class="card-header"><i class="bi bi-pencil-square me-2"></i>Edit Perangkat — {{ $device->asset_code }}</div>
    <div class="card-body">
        <form method="POST" action="{{ route('devices.update', $device) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="ram_size" class="form-control" value="{{ old('ram_size', $device->ram_size) }}" min="0">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Storage (GB)</label>
                    <input type="number" name="storage_size" class="form-control" value="{{ old('storage_size', $device->storage_size) }}" min="0">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="warranty_until" class="form-control"
                        value="{{ old('warranty_until', $device->warranty_until?->format('Y-m-d')) }}">
                </div>
                <div class="col-12">
