...
<div class="card shadow-sm" style="max-width:680px">
    <div class="card-header"><i class="bi bi-plus-circle me-2"></i>Tambah Sparepart Baru</div>
    <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="part_name" class="form-control @error('part_name') is-invalid @enderror"
                        value="{{ old('part_name') }}" placeholder="RAM DDR4..." required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="unit_price" class="form-control" value="{{ old('unit_price', 0) }}" min="0" step="1000">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="location" class="form-control" value="{{ old('location') }}" placeholder="Rak A-1, Box 3...">
                </div>
